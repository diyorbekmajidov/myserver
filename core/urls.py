...
from myapp.views import add,get_company,get_products,get_RAM,get_products_by_color,get_products_by_price,get_products_by_img,get_products_by_name,companyes, get_oraliq_price
...
urlpatterns = [
    ...
    # path('',home),
    path('get_company/<str:gre>/', get_company, name="company"),
    ...
    path('companyes/', companyes),
    path("get_oraliq_price/<str:price>", get_oraliq_price)
]
